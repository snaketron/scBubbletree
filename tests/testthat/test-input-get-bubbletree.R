context("Tests input rules of get_bubbletree")
cat("Tests input rules of get_bubbletree \n")


test_that("missing argument", {


  expect_error(get_bubbletree(x = matrix(data = rnorm(n = 100*10), ncol = 10),
                              k = 3,
                              B = 20,
                              N_eff = 50,
                              n_start = 100,
...
test_that("null/na argument", {
  ...
  expect_error(get_bubbletree(x = NULL,
                              k = 3,
                              B = 20,
                              N_eff = 50,
                              n_start = 100,
  ...
  expect_error(get_bubbletree(x = NA,
                              k = 3,
                              B = 20,
                              N_eff = 50,
                              n_start = 100,
