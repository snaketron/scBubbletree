context("Tests input rules of get_bubbletree_louvain")
cat("Tests input rules of get_bubbletree_louvain \n")
...
test_that("missing argument", {
  ...
  expect_error(get_bubbletree_louvain(
                              r = 1,
                              B = 20,
                              N_eff = 50,
                              n_start = 100,
...
test_that("null/na argument", {
  ...
  expect_error(get_bubbletree_louvain(x = NULL,
                              r = 1,
                              B = 20,
                              N_eff = 50,
                              n_start = 100,
  ...
  expect_error(get_bubbletree_louvain(x = NA,
                              r = 1,
                              B = 20,
                              N_eff = 50,
                              n_start = 100,
