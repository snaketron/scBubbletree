...
We can also use the function `compare_bubbletrees` to compare the bubbletrees 
and the clustering solutions. The heatmap shows the cooccurrence of cells 
between the bubbles of the two bubbletrees. 

The heatmap labels are cell frequencies and the tile colors are relative 
cell abundances. From the heatmap we that with exception to 3 cells (3 blue 
tiles), the two clustering algorithms generate identical clusterings.
